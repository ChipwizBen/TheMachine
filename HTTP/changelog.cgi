...
sub html_output {
	...
	$Table->addRow('', 'All user configuration options have been moved into the database.');
	$Table->addRow('', 'A Configuration menu has been added to set the DB values (Home -> Management -> Configuration).');
