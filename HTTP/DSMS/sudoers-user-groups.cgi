...
sub html_show_links {
	...
	while ( my @Select_Links = $Select_User_Links->fetchrow_array() )
	{
		...
		while ( my @Select_User_Array = $Select_Users->fetchrow_array() )
		{
			...
			"$User",
			"$Active",
			"<a href='/DSMS/sudoers-users.cgi?ID_Filter=$User_ID'><img src=\"/Resources/Images/forward.png\" alt=\"View $User\" ></a>"
			);
		}
	}
...
sub html_output {
	...
	while ( my @Select_Groups = $Select_Groups->fetchrow_array() )
	{
		...
		$Table->addRow(
			...
			"$Last_Modified",
			"$Modified_By",
			"<a href='/DSMS/sudoers-user-groups.cgi?Show_Links=$DBID_Clean&Show_Links_Name=$Group_Name_Clean'><img src=\"/Resources/Images/linked.png\" alt=\"Linked Objects to Group ID $DBID_Clean\" ></a>",
			...
			"<a href='/DSMS/sudoers-user-groups.cgi?Edit_Group=$DBID_Clean'><img src=\"/Resources/Images/edit.png\" alt=\"Edit Group ID $DBID_Clean\" ></a>",
			"<a href='/DSMS/sudoers-user-groups.cgi?Delete_Group=$DBID_Clean'><img src=\"/Resources/Images/delete.png\" alt=\"Delete Group ID $DBID_Clean\" ></a>"
		);
