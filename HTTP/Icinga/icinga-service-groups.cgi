...
sub html_output {
	...
	while ( my @DB_Group = $Select_Groups->fetchrow_array() )
	{
		...
		$Table->addRow(
			...
			$Modified_By_Extract,
			"<a href='/Icinga/icinga-service-groups.cgi?Display_Config=$ID_Extract'><img src=\"/Resources/Images/view-notes.png\" alt=\"View Config for $Name_Extract\" ></a>",
			"<a href='/Icinga/icinga-service-groups.cgi?Edit_Group=$ID_Extract'><img src=\"/Resources/Images/edit.png\" alt=\"Edit $Name_Extract\" ></a>",
			"<a href='/Icinga/icinga-service-groups.cgi?Delete_Group=$ID_Extract'><img src=\"/Resources/Images/delete.png\" alt=\"Delete $Name_Extract\" ></a>"
		);
