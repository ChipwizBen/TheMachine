...
if ($Add_Group) {
	...
	print "Location: /Icinga/icinga2-host-groups.cgi\n\n";
	exit(0);
}
elsif ($Edit_Group) {
	require $Header;
...
<a href="/Icinga/icinga2-host-groups.cgi">
...
<form action='/Icinga/icinga2-host-groups.cgi' method='post' >
...
sub html_output {
	...
	while ( my @DB_Group = $Select_Groups->fetchrow_array() )
	{
		...
		$Table->addRow(
			"<a href='/Icinga/icinga2-host-groups.cgi?Edit_Group=$ID_Extract'>$ID_Extract_Display</a>",
			"<a href='/Icinga/icinga2-host-groups.cgi?Edit_Group=$ID_Extract'>$Name_Extract</a>",
			$Alias_Extract,
			$Active_Extract,
			$Last_Modified_Extract,
			$Modified_By_Extract,
			"<a href='/Icinga/icinga2-host-groups.cgi?Display_Config=$ID_Extract'><img src=\"/Resources/Images/view-notes.png\" alt=\"View Config for $Name_Extract\" ></a>",
			"<a href='/Icinga/icinga2-host-groups.cgi?Edit_Group=$ID_Extract'><img src=\"/Resources/Images/edit.png\" alt=\"Edit $Name_Extract\" ></a>",
			"<a href='/Icinga/icinga2-host-groups.cgi?Delete_Group=$ID_Extract'><img src=\"/Resources/Images/delete.png\" alt=\"Delete $Name_Extract\" ></a>"
		);
