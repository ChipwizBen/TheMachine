...
if ($Add_Command) {
	...
	print "Location: /Icinga2/icinga2-commands.cgi\n\n";
	exit(0);
}
elsif ($Edit_Command) {
	require $Header;
...
<a href="/Icinga2/icinga2-commands.cgi">
...
<form action='/Icinga2/icinga2-commands.cgi' method='post' >
...
sub html_show_linked {
	...
	$Select_Service_Name->execute("$Show_Linked!%");
		...
		while ( my @DB_Service = $Select_Service_Name->fetchrow_array() )
		{
			...
			my $View_Service = "<a href='/Icinga2/icinga2-services.cgi?Filter=$Service_ID'><img src=\"/Resources/Images/forward.png\" alt=\"View Service $Service_Description\" ></a>";
...
sub html_output {
	...
	while ( my @DB_Command = $Select_Commands->fetchrow_array() )
	{
		...
		$Table->addRow(
			...
			$Modified_By_Extract,
			"<a href='/Icinga2/icinga2-commands.cgi?Show_Linked=$ID_Extract'><img src='/Resources/Images/linked.png' alt='Show Linked Hosts/Services for $Name_Extract'></a>",
			"<a href='/Icinga2/icinga2-commands.cgi?Display_Config=$ID_Extract'><img src='/Resources/Images/view-notes.png' alt='View Config for $Name_Extract'></a>",
			"<a href='/Icinga2/icinga2-commands.cgi?Edit_Command=$ID_Extract'><img src='/Resources/Images/edit.png' alt='Edit $Name_Extract'></a>",
			"<a href='/Icinga2/icinga2-commands.cgi?Delete_Command=$ID_Extract'><img src='/Resources/Images/delete.png' alt='Delete $Name_Extract'></a>"
		);
