...
if ($Add_Contact) {
	...
	print "Location: /Icinga2/icinga2-contacts.cgi\n\n";
	exit(0);
}
elsif ($Edit_Contact) {
	require $Header;
...
<a href="/Icinga2/icinga2-contacts.cgi">
...
<form action='/Icinga2/icinga2-contacts.cgi' method='post' >
...
sub html_output {
	...
	while ( my @DB_Contact = $Select_Contacts->fetchrow_array() )
	{
			...
			while ( my @DB_Host_Command_Link = $Select_Host_Command_Link->fetchrow_array() )
			{
				...
				while ( my @DB_Host_Command_Conversion = $Select_Host_Command_Name->fetchrow_array() )
				{
					$Host_Notification_Command_Conversion = "$Host_Notification_Command_Conversion
						<a href='/Icinga2/icinga2-commands.cgi?Filter=$DB_Host_Command_Conversion[0]'>
			...
			while ( my @DB_Service_Command_Link = $Select_Service_Command_Link->fetchrow_array() )
			{
				...
				while ( my @DB_Service_Command_Conversion = $Select_Service_Command_Name->fetchrow_array() )
				{
					$Service_Notification_Command_Conversion = "$Service_Notification_Command_Conversion
						<a href='/Icinga2/icinga2-commands.cgi?Filter=$DB_Service_Command_Conversion[0]'>
		...
		$Table->addRow(
			"<a href='/Icinga2/icinga2-contacts.cgi?Edit_Contact=$ID_Extract'>$ID_Extract_Display</a>",
			"<a href='/Icinga2/icinga2-contacts.cgi?Edit_Contact=$ID_Extract'>$Name_Extract</a>",
			$Alias_Extract,
			"<a href='/Icinga2/icinga2-time-periods.cgi?Filter=$Host_Notification_Period_Conversion'>$Host_Notification_Period_Conversion</a>",
			"<a href='/Icinga2/icinga2-time-periods.cgi?Filter=$Service_Notification_Period_Conversion'>$Service_Notification_Period_Conversion</a>",
			...
			$Modified_By_Extract,
			"<a href='/Icinga2/icinga2-contacts.cgi?Display_Config=$ID_Extract'><img src=\"/Resources/Images/view-notes.png\" alt=\"View Config for $Name_Extract\" ></a>",
			"<a href='/Icinga2/icinga2-contacts.cgi?Edit_Contact=$ID_Extract'><img src=\"/Resources/Images/edit.png\" alt=\"Edit $Name_Extract\" ></a>",
			"<a href='/Icinga2/icinga2-contacts.cgi?Delete_Contact=$ID_Extract'><img src=\"/Resources/Images/delete.png\" alt=\"Delete $Name_Extract\" ></a>"
		);
